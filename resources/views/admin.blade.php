                    ...
                    <template x-cloak x-if="first_load">
                        <div class="bg-white overflow-hidden shadow-md rounded-lg px-6 py-8 max-h-screen overflow-y-auto">
                            <div class="flex items-center gap-2 mb-6">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mb-1 flex-shrink-0">
                        ...
                        <div x-init="select_user({id: {{ Auth::user()->id }}, name: '{{ Auth::user()->name }}'})" class="bg-white overflow-hidden shadow-md rounded-lg px-6 py-8 max-h-screen overflow-y-auto">
                            ...
                            <div class="flex flex-col gap-y-4 min-h-80">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <label class="text-zinc-700 text-sm font-bold mb-1 flex flex-row items-center gap-x-2">Select User
                                ...
                                <div class="flex flex-col gap-y-4">
                                    <template x-cloak x-if="user_data">
                                        <div class="flex flex-col">
                                            <label class="text-zinc-700 text-sm font-bold mb-1 flex flex-row items-center gap-x-2">User Data</label>
                                        ...
                                        <div class="flex flex-col gap-y-4">
                                            ...
                                            <div x-data="{ show_future: false }" class="flex flex-col gap-4">
                                                <button @click="show_future = !show_future" class="flex items-center gap-2 text-zinc-600 hover:text-zinc-800">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 flex-shrink-0" :class="{ 'rotate-180': show_future }">
                                            ...
                                            <div x-data="{ show_past: false }" class="flex flex-col gap-4">
                                                <button @click="show_past = !show_past" class="flex items-center gap-2 text-zinc-600 hover:text-zinc-800">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 flex-shrink-0" :class="{ 'rotate-180': show_past }">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                                    </svg>
                                ...
                                <div class="flex flex-col gap-4">
                                    <div x-data="{ new_custom_hours: false }" class="flex flex-col gap-2">
                                        ...
                                        <button @click="new_custom_hours = !new_custom_hours" class="flex items-center gap-2 text-zinc-600 hover:text-zinc-800">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 flex-shrink-0" :class="{ 'rotate-180': new_custom_hours }">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                            </svg>
                                ...
                                <div class="flex flex-col gap-4">
                                    <div x-data="{ new_table: false }" class="flex flex-col gap-2">
                                        <button @click="new_table = !new_table" class="flex items-center gap-2 text-zinc-600 hover:text-zinc-800">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 flex-shrink-0" :class="{ 'rotate-180': new_table }">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                            </svg>
                                            Add New Table
                                        </button>
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div class="flex gap-2">
                                            <input type="number" x-model="min_hours_before_reservation" min="0" step="1" class="bg-white shadow appearance-none border rounded py-2 px-3 text-zinc-700 leading-tight focus:outline-none w-full max-w-md">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div class="flex gap-2">
                                            <input type="number" x-model="max_future_reservations" min="0" step="1" class="bg-white shadow appearance-none border rounded py-2 px-3 text-zinc-700 leading-tight focus:outline-none w-full max-w-md">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div class="flex gap-2">
                                            <input type="number" x-model="max_days_in_advance" min="0" step="1" class="bg-white shadow appearance-none border rounded py-2 px-3 text-zinc-700 leading-tight focus:outline-none w-full max-w-md">
